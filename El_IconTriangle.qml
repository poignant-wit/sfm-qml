...
Canvas {
    ...
    height: 20
              ...
              property int triangleWidth: width-12
              property int triangleHeight: height-12
              property color strokeStyle:  "grey"
              property color fillStyle: "grey"
              ...
              states: [
                  State {
                      ...
                      PropertyChanges { target: triangle; fill: false; }
                  }
              ]
